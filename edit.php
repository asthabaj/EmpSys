...
<div class="container mt-5">
    ...
    <form method="POST" action="">
        <div class="form-group">
            ...
            <input type="text" name="fname" id="fname" class="form-control" value="<?php echo $employee['fname']; ?>" required>
        </div>
        <div class="form-group">
            <label for="lname">Last Name</label>
            <input type="text" name="lname" id="lname" class="form-control" value="<?php echo $employee['lname']; ?>" required>
        </div>
        <div class="form-group">
            <label for="email">Email</label>
            <input type="email" name="email" id="email" class="form-control" value="<?php echo $employee['email']; ?>" required>
        </div>
        <div class="form-group">
            <label for="phone">Phone</label>
            <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $employee['phone']; ?>" required>
        </div>
        <div class="form-group">
        ...
        <a href="employeedata.php" class="btn btn-secondary">Cancel</a>
    </form>
</div>
